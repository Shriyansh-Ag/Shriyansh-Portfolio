...
const NavBar = () => {
  ...
  return (
    <nav className="fixed bottom-10 left-0 right-0 z-50 my-0  mx-auto  flex w-[306px] items-center justify-center gap-1 rounded-lg bg-[#07070a]/90 px-1 py-1 text-[#e4ded7] backdrop-blur-md sm:w-[383.3px] md:p-2 lg:w-[391.3px]">
      <Link
        href="https://drive.google.com/file/d/1BlTCRnO7RmGZb3sDRMq-4KoSue2vO9ML/view?usp=sharing"
        target="_blank"
        className="flex"
      ...
      >
        <h4 className="rounded py-2 px-2 sm:px-4 text-[10px] sm:text-[12px] md:py-1 md:px-4">
          Home
        </h4>
      </Link>
      <Link
